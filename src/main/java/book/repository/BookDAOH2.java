...
import javax.sql.DataSource; // 추가된 부분!
...
public class BookDAOH2 implements BookDAO {
    ...
    // 💡 핵심 변경: Connection 대신 DataSource를 주입받습니다.
    @Autowired
    ...
    public int insert(BookVO book) {
        ...
        // try-with-resources 구문을 사용하여 Connection도 자동으로 닫히게 처리합니다.
    ...
    public BookVO findById(int id) {
        ...
        try (Connection conn = dataSource.getConnection();
            ...
            try (ResultSet rs = ps.executeQuery()) {
                if (rs.next()) {
                    return resultSetToBook(rs); // 중복 코드 제거하고 기존 메서드 활용
                }
            }

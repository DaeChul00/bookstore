	...
	<div class="container">
		...
		<div class="detail-box">
			...
			<div class="book-info">
				...
				<div class="meta">${bk.author} · ${bk.publisher} ·
					${bk.publictiondate}</div>
				<div class="price">
					<fmt:formatNumber value="${bk.price}" type="number" />
					원
				</div>
				...
				<div
					...
					<form action="${pageContext.request.contextPath}/order/addCart"
						method="post">
						<input type="hidden" name="bookId" value="${bk.id}">
						[cite: 43] <span style="font-weight: bold; margin-right: 10px;">구매
							수량</span> <input type="number" name="count" value="1" min="1"
							style="width: 60px; padding: 5px; border: 1px solid #ddd; border-radius: 4px;">
						<button type="submit" class="btn"
							style="background-color: #479e10; margin-left: 10px;">
							🛒 장바구니 담기</button>
					</form>
				</div>
				<div class="btn-area">

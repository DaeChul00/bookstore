				...
				<sec:authorize
					...
					<div style="position: relative; display: inline-block;">
						...
						<div class="admin-dropdown"
							style="display: none; position: absolute; top: 100%; right: 0; background: white; border: 1px solid #eee; border-radius: 8px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1); z-index: 1000; padding: 10px; width: 140px;">
